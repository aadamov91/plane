  ...
  auth: {
    ...
    ui: {
      header: {
        ...
        sign_up: "Создайте аккаунт Plane.",
      },
      invitation: {
        sign_in: "Войдите, чтобы начать управлять работой вместе с командой.",
        sign_up: "Создайте аккаунт, чтобы начать управлять работой вместе с командой.",
      },
      legal: {
        sign_in_prefix: "Продолжая вход, вы соглашаетесь с нашими",
        sign_up_prefix: "Создавая аккаунт, вы соглашаетесь с нашими",
        and: "и",
        terms_of_service: "Условиями использования",
        privacy_policy: "Политикой конфиденциальности",
      },
      no_methods: {
        title: "Нет доступных способов входа",
        description: "Обратитесь к администратору, чтобы включить вход для этого инстанса.",
      },
    },
    sign_up: {
      header: {
